...
public interface GroupRepository extends JpaRepository<Group, Long> {
    ...
    Set<Group> findGroupsByNameWithLimitOffset(String userId, String search, int limit, int offset);
    ...
    Set<Group> findGroupsAUserIsIn(String userId);
    ...
    Group findGroupByIdIfUserHasAccess(String userId, Long groupId);
