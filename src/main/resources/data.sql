...
VALUES ('2023-10-10 10:15', null, null, false, '7e68cd4b-7bd0-4ab1-b2df-09bf54f7e87e',
        'Alumni applikasjonen',
        'Hva synes dere om denne applikasjonen? Vennligst gi svar under', 2);

-- Post 2
INSERT INTO Post (created_at, starts_at, ends_at, is_event, owner_id, title, content, group_id)
VALUES ('2023-10-10 10:15', null, null, false, '4535e26b-692c-4fc6-a1c9-9e164d1daf7c',
        'Okaaaaay ',
        'leezgo', 2);

-- Post 3
INSERT INTO Post (created_at, starts_at, ends_at, is_event, owner_id, title, content, group_id)
VALUES ('2023-10-10 10:15', null, null, false, '71677904-aa91-4894-96b7-45521a921172',
        'Simplicity in Design',
        'Designing with simplicity in mind is like telling a story with few words - it ensures clarity and ease of use.', 2);

INSERT INTO Post (created_at, starts_at, ends_at, is_event, owner_id, title, content, group_id)
VALUES ('2023-10-10 10:15', null, null, false, 'mockuser1',
        'Mjau',
        'mjau mjau', 2);
-- Post 4
INSERT INTO Post (created_at, starts_at, ends_at, is_event, owner_id, title, content, group_id)
VALUES ('2023-10-10 10:15', null, null, false, 'd7ab172c-7cab-4bf1-b94e-3e38a7400793',
